  ...
  <div class="max-w-6xl mx-auto px-6 py-4 flex items-center gap-5">
    ...
    <div class="ml-auto flex items-center gap-6">
      <nav class="hidden md:flex items-center gap-7 text-sm text-zinc-400">
        ...
        <a href="{theater_url}" target="_blank" rel="noopener noreferrer" title="Watch published debates in the Debate Chat Theater" class="hover:text-zinc-100 transition">Theater ↗</a>
